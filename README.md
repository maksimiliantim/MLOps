...
Требуется спроектировать поисковую систему для платформы электронной коммерции, которая по текстовому запросу пользователя (например, *«зимние ботинки женские»*) формирует **ранжированный список товаров**. Ранжирование должно учитывать:
...
### 1.3 Кандидатные модели (минимум 2)
